    ...
    <div className='descriptionbox'>
      ...
      <div className='descriptionbox-description'>
        <p>
          ...
          products, interact with costumers, and conduct, interact with
          costumers, and conduct transactions without the need for a physical
          presence. E-commercial websites have gained immense popularity due to
          their convinience accessibility, and the global reach they offer.
        </p>
        <p>
          ...
          colors). Each product usually has its own dedication with relevant
          information.
        </p>
      </div>
    </div>
